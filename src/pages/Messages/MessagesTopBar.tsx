    ...
    return (
        <Box
            sx={{
                ...
                color: muted ? (t) => t.palette.text.disabled : (t) => t.palette.text.secondary,
    ...
    return (
        <Button
            ...
            sx={{
                ...
                transition: "all 0.2s ease",
                "&:hover": {
                    backgroundColor: muted ? (t) => t.palette.action.hover : "rgba(124,92,252,0.12)",
                    color: muted ? (t) => t.palette.text.secondary : (t) => t.palette.text.primary,
                },
            }}
        >
                                ...
                                <Grid item xs={3} key={index}>
                                    <Box
                                        ...
                                        sx={{
                                            ...
                                            background: value === "black" ? theme.palette.background.default : value,
                                            backgroundSize: "cover",
                                            backgroundPosition: "center",
                                            cursor: "pointer",
                                            borderRadius: "12px",
                                            border: isSelected ? "2px solid rgba(124,92,252,0.9)" : `2px solid ${theme.palette.divider}`,

...
import { Typography, IconButton, Avatar, Box, TextField, Dialog, Button, Popover, Skeleton, CircularProgress } from "@mui/material";
import BlankProfileImage from "../../static/profile_blank.png";
import { FavoriteBorder, Favorite, MoreHoriz, Close, ChatBubbleOutline, SentimentSatisfiedAlt as EmojiIcon } from "@mui/icons-material";
...
/* ─── Component ─────────────────────────────────────────────────── */
const ModalPost: React.FC<PostProps> = ({ postId, fetchPosts, isMobile, handleCloseModal, userId }) => {
    ...
    const handleLikeComment = async (commentId: number) => {
        ...
        setPost({
            ...post,
            comments: post.comments.map((c) => (c.id === commentId ? { ...c, liked_by_user: newLiked, likes_count: newCount } : c)),
        });
        try {
                ...
                >
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                        ...
                        <Box>
                            ...
                            <Skeleton variant="text" width={60} height={13} sx={{ bgcolor: "rgba(255,255,255,0.04)" }} />
                        </Box>
                    </Box>
                    <Skeleton variant="text" width="85%" height={15} sx={{ bgcolor: "rgba(255,255,255,0.05)" }} />
                    <Skeleton variant="text" width="65%" height={15} sx={{ bgcolor: "rgba(255,255,255,0.04)" }} />
                    ...
                    {[1, 2, 3].map((i) => (
                        <Box key={i} sx={{ display: "flex", gap: 1.5, alignItems: "flex-start" }}>
                            ...
                            <Box sx={{ flex: 1 }}>
                                ...
                                <Skeleton variant="text" width="80%" height={13} sx={{ bgcolor: "rgba(255,255,255,0.04)" }} />
                            </Box>
                        </Box>
                    ))}
                </Box>
        ...
        <>
                ...
                >
                    ...
                    {post?.content && (
                        ...
                        >
                            ...
                            >
                                <Box component="span" sx={{ fontWeight: 600, color: "#e8eaed", mr: 0.75 }}>
                                    {post.username}
                                </Box>
                                {post.content}
                            </Typography>
                                        ...
                                        >
                                            <IconButton
                                                ...
                                                sx={{
                                                    ...
                                                    "&:hover": {
                                                        backgroundColor: "transparent",
                                                        color: comment.liked_by_user ? "#e63946" : "#9aa0a6",
                                                    },
                                                }}
                                            >
                            ...
                            <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                                <IconButton
                                    ...
                                    sx={{
                                        ...
                                        "&:hover": {
                                            backgroundColor: "transparent",
                                            color: post?.liked_by_current_user ? "#e63946" : "#9aa0a6",
                                        },
                                    }}
                                >
                                    {post?.liked_by_current_user ? <Favorite sx={{ fontSize: 22 }} /> : <FavoriteBorder sx={{ fontSize: 22 }} />}
                                </IconButton>
                                <Typography
                                    sx={{
                                        fontFamily: "'DM Sans', sans-serif",
                    ...
                    {currentUser?.id && (
                        ...
                        >
                            ...
                            >
                                {postingCommentLoading ? <CircularProgress size={14} sx={{ color: "#9aa0a6" }} /> : "Post"}
                            </Button>
                        </Box>
                    )}
                </Box>
            ...
            >
                ...
                >
                    ...
                    >
                        {editingPostLoading ? <CircularProgress size={14} sx={{ color: "#9aa0a6" }} /> : "Save"}
                    </Button>
                </Box>
            </Dialog>
            ...
            >
                <EmojiPicker theme={Theme.DARK} onEmojiClick={(e) => setCommentText((p) => p + e.emoji)} />
            </Popover>

...
const CSS = `
  ...
  /* ── Search ── */
  .msg-search-wrap {
    padding: 10px 12px 10px; flex-shrink: 0; position: relative; z-index: 1;
  }
...
const MessagesUserList: React.FC<MessagesUserListProps> = ({ users, onlineUsers, handleUserClick, activeUserId, loading = false }) => {
    ...
    return (
        <div className="msg-list-root">
            ...
            <div className="msg-header">
                ...
                {!loading && totalUnread > 0 && <span className="msg-header-count">{totalUnread} new</span>}
            </div>
            ...
            {loading ? (
                ...
                <div className="msg-empty">
                    ...
                    <p className="msg-empty-text">{search ? "No results found" : "No conversations yet."}</p>
                </div>
            ) : (
                <>
                    <ul className="msg-list" role="list" style={{ margin: 0, padding: "4px 8px", listStyle: "none" }}>
                        {filtered.map((user, i) => {

            ...
            >
              ...
              >
                ...
                {imageFile ? (
                  ...
                  // Empty state — update the format chips and text
                  <Box sx={{ textAlign: "center", p: 3, userSelect: "none" }}>
                    ...
                    >
                      <AddPhotoAlternate
                        sx={{
                          fontSize: 22,
                          color: isDragging ? accent : "text.disabled",
                        }}
                      />
                    </Box>
                    <Typography
                    ...
                    <Typography
                      sx={{ fontSize: "13px", color: "text.disabled", mb: 1.5 }}
                    >
                      or click to browse
                    </Typography>
                    <Box
                    ...
                    >
                      {["JPG", "PNG", "GIF", "WEBP", "MP4", "MOV", "WEBM"].map(
                        (ext) => (
                          <Box
                            key={ext}
                            sx={{
            ...
            >
              ...
              >
                ...
                {postContent.match(/#([a-zA-Z0-9_]+)/g) && (
                  ...
                  >
                    {[...new Set(postContent.match(/#([a-zA-Z0-9_]+)/g))].map(
                      (tag) => (
                        <Box
                          key={tag}
                          sx={{
                            ...
                            border: `0.5px solid ${alpha(accent, 0.25)}`,
                            borderRadius: "999px",
                            px: 1.25,
                            py: "3px",
                            letterSpacing: "0.2px",

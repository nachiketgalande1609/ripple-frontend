...
import { Box, Button, LinearProgress, Modal, Stack, Typography, useTheme } from "@mui/material";
    ...
    useEffect(() => {
        ...
        const fetchNotificationCount = async () => {
            try {
                ...
                notifications.show("Error fetching notification count. Please try again later.", { severity: "error", autoHideDuration: 3000 });
            }
        };
        ...
        >
            ...
            >
                ...
                >
                    ...
                    />
                    <Typography sx={{ color: (t) => t.palette.text.primary, fontWeight: 600 }}>{incomingCall?.callerUsername}</Typography>
                    <Typography sx={{ fontSize: "0.9rem", color: (t) => t.palette.text.secondary }}>is calling you</Typography>
                    <Stack direction="row" spacing={1.5} justifyContent="center" sx={{ mt: 2 }}>
                        <Button variant="contained" color="success" onClick={handleAcceptCall} sx={{ borderRadius: "15px", width: "150px" }}>
                            Accept
                        </Button>
                        <Button variant="contained" color="error" onClick={handleRejectCall} sx={{ borderRadius: "15px", width: "150px" }}>
                            Reject
                        </Button>
                    </Stack>
                </Box>

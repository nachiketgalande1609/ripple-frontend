  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1, overflow: "hidden" }}>
        ...
        <Typography
          onClick={() => navigate(`/profile/${selectedUser?.id}`)}
          sx={{ cursor: "pointer", color: "#e8eaed", fontWeight: 500, fontSize: "0.92rem", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", "&:hover": { color: "#fff" } }}
        >
      ...
      >
        <DialogButton
          ...
          onClick={() => { setOpenColorDialog(true); setOpenThemeDialog(false); }}
        />

...
import {
  Avatar, Button, Box, TextField, IconButton,
  CircularProgress, Dialog, DialogContent,
  Typography, Alert, Collapse, Fade, Grow
} from "@mui/material";
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {profileUpdating ? (
              <CircularProgress size={15} sx={{ color: "rgba(0,0,0,0.4)" }} />
            ) : (
              "Save Changes"
            )}
          </Button>
      ...
      >
          ...
          {uploading ? (
            ...
            <Box
              ...
              sx={{
                ...
                borderRadius: "14px",
                border: isDragActive
                  ? "2px dashed rgba(160,150,255,0.6)"
                  : "2px dashed rgba(255,255,255,0.09)",
                backgroundColor: isDragActive
                  ? "rgba(160,150,255,0.05)"
        ...
        >
          {newProfilePic && !uploading && (
            <Button
              onClick={() => { setNewProfilePic(null); setUploadError(""); }}
              sx={{
                fontFamily: "'DM Sans', sans-serif",
                fontSize: "0.82rem",
                fontWeight: 500,
